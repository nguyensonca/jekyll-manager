...
export default function datafiles(
  ...
  switch (action.type) {
    ...
    case FETCH_DATAFILES_FAILURE:
      return { ...state, isFetching: false, currentFile: {} };
    case FETCH_DATAFILE_SUCCESS:
      return { ...state, currentFile: action.file, isFetching: false };
    case FETCH_DATAFILE_FAILURE:
      return { ...state, currentFile: {}, isFetching: false };
    ...
    case PUT_DATAFILE_FAILURE:
      return { ...state, datafileChanged: false };
    case DATAFILE_CHANGED:
      return { ...state, datafileChanged: true, updated: false };
    default:
      return { ...state, updated: false, datafileChanged: false };
  }
}
