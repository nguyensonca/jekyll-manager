...
describe('Actions::Pages', () => {
  ...
  it('fetches pages successfully', () => {
    ...
    return store.dispatch(pagesDuck.fetchPages()).then(() => {
  ...
  it('updates the page successfully', () => {
    ...
    return store.dispatch(pagesDuck.putPage('edit', '', 'page.md')).then(() => {
      expect(store.getActions()).toEqual(expectedActions);
    });
  });
  ...
  it('creates the page successfully', () => {
    ...
    return store.dispatch(pagesDuck.putPage('create')).then(() => {
      expect(store.getActions()).toEqual(expectedActions);
    });
  });
