...
export const updateTemplate = (prop, value) => ({
...
export default function metadata( // TODO normalize the metadata
  state = {
    metadata: {},
    new_field_count: 1,
    key_prefix: '', // force children to be re-rendered on sort
    fieldChanged: false,
  },
  action
) {
  switch (action.type) {
    ...
    case STORE_CONTENT_FIELDS:
      return { ...state, metadata: action.content };
    case ADD_METAFIELD:
      return {
        ...state,
    ...
    default:
      return { ...state, fieldChanged: false };
  }
}
