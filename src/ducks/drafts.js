...
export default function drafts(
  ...
  switch (action.type) {
    ...
    case FETCH_DRAFTS_SUCCESS:
      return { ...state, drafts: action.drafts, isFetching: false, draft: {} };
    case FETCH_DRAFTS_FAILURE:
      return { ...state, isFetching: false, drafts: [] };
    case FETCH_DRAFT_SUCCESS:
      return { ...state, draft: action.draft, isFetching: false };
    case FETCH_DRAFT_FAILURE:
      return { ...state, draft: {}, isFetching: false };
    case PUT_DRAFT_SUCCESS:
      return { ...state, draft: action.draft, updated: true };
    default:
